...
[![CI](https://github.com/DrSoma/PathSafe/actions/workflows/test.yml/badge.svg)](https://github.com/DrSoma/PathSafe/actions/workflows/test.yml)
[![PyPI version](https://badge.fury.io/py/pathsafe.svg)](https://pypi.org/project/pathsafe/)
...
| **Linux (x64)** | [pathsafe-gui-linux.AppImage](https://github.com/DrSoma/PathSafe/releases/latest/download/pathsafe-gui-linux.AppImage) |
| **Linux (ARM64)** | [pathsafe-gui-linux-arm64.AppImage](https://github.com/DrSoma/PathSafe/releases/latest/download/pathsafe-gui-linux-arm64.AppImage) |
