...
|--------|-------|-------------|
| test_svs.py | 12 | SVS handler: scan, anonymize, extended PHI fields (Time Zone, ImageID, Left, Top, camera calibration) |
| test_ndpi.py | 19 | NDPI handler: scan, anonymize, private tag sweep, scanprofile (65477), barcode type (65480) |
...
| test_verify.py | 7 | Post-anonymization verification |
