...
| Serial number | TIFF tag 65442 (NDPI_SERIAL_NUMBER) | Overwritten with 'X' characters + null terminator |
| Scan profile XML | TIFF tag 65477 (NDPI_SCANPROFILE) | Overwritten with 'X' characters + null terminator |
| Barcode type config | TIFF tag 65480 (NDPI_BARCODE_TYPE) | Overwritten with 'X' characters + null terminator |
| Scan dates | TIFF tag 306 (DateTime) | Zeroed with null bytes |
| EXIF dates | TIFF tags 36867, 36868 | Zeroed with null bytes |
| Scanner properties | TIFF tag 65449 (Created, Updated, NDP.S/N, Macro.S/N, Firmware.Version) | Selective key-value redaction with 'X' characters |
...
| Time zone | Tag 270 ImageDescription (Time Zone) | Overwritten with 'X' characters |
| Operator name | Tag 270 ImageDescription (User) | Overwritten with 'X' characters |
| DSR ID | Tag 270 ImageDescription (DSR ID) | Overwritten with 'X' characters |
| Image ID | Tag 270 ImageDescription (ImageID) | Overwritten with 'X' characters |
| Stage coordinates | Tag 270 ImageDescription (Left, Top) | Overwritten with 'X' characters |
| Camera calibration | Tag 270 ImageDescription (LineCameraSkew, LineAreaXOffset, LineAreaYOffset) | Overwritten with 'X' characters |
| Scan dates | TIFF tag 306 (DateTime) | Zeroed with null bytes |
...
- **Offline by default**: PathSafe works offline by default. All file processing happens locally on the user's machine. No patient data ever leaves the system. An optional update checker (disabled by default) can query GitHub for new version information -- it sends no file data or PHI.
